...
net_arg.add_argument(
    "--sr", type=float, default=1.0, help=""
...
data_arg.add_argument(
    "--data_tr", type=str, default='/localssd/s01017/yfcc-sift-2000-train.hdf5', help=""
    "name of the dataset for train")
data_arg.add_argument(
    "--data_va", type=str, default='/localssd/s01017/yfcc-sift-2000-val.hdf5', help=""
    "name of the dataset for valid")
data_arg.add_argument(
    "--data_te", type=str, default='/localssd/s01017/yfcc-sift-2000-test.hdf5', help=""
...
train_arg.add_argument(
    ...
    "batch size")
train_arg.add_argument(
    "--gpu_id", type=str, default='6', help='id(s) for CUDA_VISIBLE_DEVICES')
train_arg.add_argument(

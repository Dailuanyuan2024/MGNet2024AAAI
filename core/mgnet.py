...
class MGNet(nn.Module):
    def __init__(self, config):
        ...
        self.mg_0 = MG_Block(initial=True, predict=False, out_channel=128, k_num=24, sampling_rate=config.sr)
        self.mg_1 = MG_Block(initial=False, predict=True, out_channel=128, k_num=24, sampling_rate=config.sr)
    ...
    def forward(self, x, y):
        ...
        return ws0 + ws1, [y, y1, y2], [e_hat], y_hat
